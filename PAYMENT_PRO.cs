...
{
    public partial class PAYMENT_PRO : Form
    {
        public PAYMENT_PRO()
        {
            InitializeComponent();
        ...
        private void add_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            string sql = string.Format("insert into Reglement_Prof values (@ID_PAY,@amount,@payday,@ID_PRO)");
            SqlCommand cmd = new SqlCommand(sql, conn);
            cmd.Parameters.AddWithValue("@ID_PAY", int.Parse(textBox1.Text));
            cmd.Parameters.AddWithValue("@amount", textBox2.Text);
            cmd.Parameters.AddWithValue("@payday", DateTime.Parse(dateTimePicker1.Text));
            cmd.Parameters.AddWithValue("@ID_PRO", int.Parse(textBox4.Text));
            cmd.ExecuteNonQuery();
            conn.Close();
        ...
        private void update_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection(DB);
            conn.Open();
            string sql = string.Format("update Reglement_Prof set Montant_regler=@amount, Date_reglement=@payday, NumProf#=@ID_PRO where id_reglement=@ID_PAY");
            SqlCommand cmd = new SqlCommand(sql, conn);
            cmd.Parameters.AddWithValue("@ID_PAY", int.Parse(textBox1.Text));
            cmd.Parameters.AddWithValue("@amount", textBox2.Text);
            cmd.Parameters.AddWithValue("@payday", DateTime.Parse(dateTimePicker1.Text));
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection(DB);
            conn.Open();
            string sql = string.Format("delete Reglement_Prof where id_reglement=@ID_PAY");
            SqlCommand cmd = new SqlCommand(sql, conn);
            cmd.Parameters.AddWithValue("@ID_PAY", int.Parse(textBox1.Text));
            cmd.ExecuteNonQuery();
            conn.Close();
        ...
        private void search_Click(object sender, EventArgs e)
        {
            ...
            SqlConnection conn = new SqlConnection(DB);
            conn.Open();
            string sql = string.Format("select * from Reglement_Prof where NumProf#=@ID_PRO");
            SqlCommand cmd = new SqlCommand(sql, conn);
            cmd.Parameters.AddWithValue("@ID_PRO", int.Parse(textBox4.Text));
            cmd.ExecuteNonQuery();
        ...
        private void PAYMENT_PRO_Load(object sender, EventArgs e)
        {
            string DB = "Data Source=DESKTOP-SRGINA2;Initial Catalog=ecole;Integrated Security=True";
            SqlConnection conn = new SqlConnection(DB);
            conn.Open();
            string sql = string.Format("select * from Reglement_Prof");
            SqlCommand cmd = new SqlCommand(sql, conn);
            SqlDataAdapter adapter = new SqlDataAdapter(cmd);
            DataTable dt = new DataTable();
            adapter.Fill(dt);
